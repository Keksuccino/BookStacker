//Copyright (c) 2020-2021 Keksuccino
...
import de.keksuccino.core.config.ConfigEntry.*;
 ...
 * 
 * Caches values to prevent reading the config file everytime, so values can be called rapidly without stressing the system.
 * 
 * @author Keksuccino
 * @version 03.07.21.animationmaker.custom
 */
public class Config {
	 ...
	 * It is needed to call {@code Config.syncConfig()} after this to synchronize the new values with the config file.
	 */
	public void registerValue(String uniqueName, Integer defaultValue, String category, String description) throws InvalidValueException {
	 ...
	 * It is needed to call {@code Config.syncConfig()} after this to synchronize the new values with the config file.
	 */
	public void registerValue(String uniqueName, Double defaultValue, String category, String description) throws InvalidValueException {
	 ...
	 * It is needed to call {@code Config.syncConfig()} after this to synchronize the new values with the config file.
	 */
	public void registerValue(String uniqueName, Float defaultValue, String category, String description) throws InvalidValueException {
	 ...
	 * It is needed to call {@code Config.syncConfig()} after this to synchronize the new values with the config file.
	 */
	public void registerValue(String uniqueName, Long defaultValue, String category, String description) throws InvalidValueException {
	 ...
	 * It is needed to call {@code Config.syncConfig()} after this to synchronize the new values with the config file.
	 */
	public void registerValue(String uniqueName, Boolean defaultValue, String category, String description) throws InvalidValueException {
	 ...
	 * It is needed to call {@code Config.syncConfig()} after this to synchronize the new values with the config file.
	 */
	public void registerValue(String uniqueName, String defaultValue, String category, String description) throws InvalidValueException {
		this.registerRawValue(uniqueName, defaultValue, category, EntryType.STRING, description);
	}

	private void registerRawValue(String uniqueName, String defaultValue, String category, EntryType type, String description) throws InvalidValueException {
		if (uniqueName == null) {
